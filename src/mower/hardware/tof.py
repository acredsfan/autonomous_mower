...
class VL53L0XSensors:
    def __init__(self):
        ...
        if platform.system() == "Linux":
            ...
            logging.info(
                "Non-Linux platform. ToF sensors will be simulated."
            )
    ...
    def init_vl53l0x(i2c, address, sensor_name="Sensor"):
        ...
        try:
            ...
            logging.info(
                f"{sensor_name} VL53L0X initialized at address {hex(address)}."
            )
            return sensor
    ...
    def init_vl53l0x_sensors(
        ...
        temp_sensor = VL53L0XSensors.init_vl53l0x(
            i2c, _DEFAULT_I2C_ADDRESS, "Right Sensor (default addr)"
        )
        if temp_sensor:
        ...
        if right_sensor_obj and right_sensor_obj.device_address == _DEFAULT_I2C_ADDRESS:
        ...
        temp_sensor = VL53L0XSensors.init_vl53l0x(
            i2c, _DEFAULT_I2C_ADDRESS, "Left Sensor (default addr)"
        )
        if temp_sensor:
