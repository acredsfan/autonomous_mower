...
MODEL_URLS = {
    'yolov8n': 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8n.tflite',
    'yolov8s': 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8s.tflite',
    'yolov8m': 'https://github.com/ultralytics/assets/releases/download/v0.0.0/yolov8m.tflite'
}

# COCO dataset label map
LABELMAP_URL = 'https://raw.githubusercontent.com/ultralytics/ultralytics/main/ultralytics/datasets/coco.yaml'
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Download YOLOv8 model in TFLite format')
