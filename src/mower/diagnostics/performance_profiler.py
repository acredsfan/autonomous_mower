...
class PerformanceProfiler:
    ...
    def profile_function(self, func: Callable, *args, **kwargs) -> Dict[str, Any]:
        ...
        logger.info(f"Profiled {func.__name__}: {execution_time:.4f} seconds, {total_calls} calls")
    ...
    def _save_results(self, name: str, results: Dict[str, Any]) -> None:
        ...
        with open(stats_file, 'w') as f:
            ...
            f.write(f"Min/Max time: {results['min_time']:.4f}/{results['max_time']:.4f} seconds\n")
        ...
        plt.plot(range(1, results['iterations'] + 1), results['execution_times'], 'o-')
