...
def calibrate_blade_pwm(resource_manager: ResourceManager) -> Tuple[float, float]:
    """
...
def main():
    ...
    parser.add_argument('--steps', type=int, default=5, help='Number of speed steps for testing')
    parser.add_argument('--time', type=float, default=2.0, help='Time to run at each speed step')
