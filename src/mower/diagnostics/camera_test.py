...
def capture_test_image(resource_manager: ResourceManager, 
...
def start_stream_test(resource_manager: ResourceManager, resolution: Tuple[int, int] = (640, 480),
            ...
            <body>
                ...
                <script>
                    ...
                    setInterval(function() {
                        document.getElementById('stream').src = 'stream.jpg?t=' + new Date().getTime();
                    }, 1000);
                </script>
            </body>
            </html>
...
def main():
    ...
    parser.add_argument('--capture', action='store_true', help='Capture and display a test image')
    parser.add_argument('--save', type=str, help='Save the captured image to the specified path')
    ...
    parser.add_argument('--duration', type=int, default=30, help='Duration in seconds for the stream')
    parser.add_argument('--settings', action='store_true', help='Test different camera settings')
