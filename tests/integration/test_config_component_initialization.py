...
class TestConfigComponentInitialization:
    ...
    def setup_config_environment(self, tmpdir):
        ...
        boundary_file.write('{"boundary": [[0, 0], [10, 0], [10, 10], [0, 10]]}')
        ...
        schedule_file.write('{"schedule": [{"day": "Monday", "start": "09:00", "end": "12:00"}]}')
    ...
    def test_path_planner_initialization_from_config(self, setup_config_environment):
        ...
        with patch("mower.navigation.path_planner.get_config") as mock_get_config:
            ...
            mock_get_config.side_effect = lambda key, default=None: config_manager.get(key, default)
            ...
            pattern_config = PatternConfig(
                ...
                start_point=get_config('path_planning.start_point', (0.0, 0.0)),
            ...
            learning_config = LearningConfig(
                ...
                model_path=get_config('path_planning.learning.model_path', "model.h5")
            )
            ...
            assert path_planner.pattern_config.boundary_points == [[0, 0], [10, 0], [10, 10], [0, 10]]
            ...
            assert path_planner.learning_config.model_path == str(setup_config_environment["config_dir"] / "model.h5")
    ...
    def test_config_file_loading(self, setup_config_environment):
        ...
        with patch("mower.mower.ResourceManager") as MockResourceManager:
            ...
            mower.set_mowing_schedule([{"day": "Monday", "start": "09:00", "end": "12:00"}])
            ...
            mock_resource_manager._save_config.assert_any_call("boundary.json", {"boundary": [[0, 0], [10, 0], [10, 10], [0, 10]]})
            mock_resource_manager._save_config.assert_any_call("no_go_zones.json", {"zones": [[[2, 2], [4, 2], [4, 4], [2, 4]]]})
            mock_resource_manager._save_config.assert_any_call("schedule.json", {"schedule": [{"day": "Monday", "start": "09:00", "end": "12:00"}]})