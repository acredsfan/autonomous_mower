...
class TestGetTimezoneForCoordinates(unittest.TestCase):
    ...
    def _mock_urlopen_response(self, mock_urlopen_patch, status_code=200, response_dict=None, read_side_effect=None, is_http_error=False, http_error_code=None, http_error_reason=None):
    ...
    def test_api_key_missing(self, mock_logger_error):
        ...
        mock_logger_error.assert_called_with(
            "Cannot fetch timezone: GOOGLE_MAPS_API_KEY is not set."
        )
    ...
    def test_network_http_error(self, mock_logger_error, mock_urlopen):
        ...
        self._mock_urlopen_response(mock_urlopen, is_http_error=True, http_error_code=503, http_error_reason="Service Unavailable")
