...
from mower.weather.weather_scheduler import WeatherAwareScheduler, MowingRecommendation
...
class TestWeatherAwareScheduler(unittest.TestCase):
    ...
    def test_get_next_mowing_time_good_weather_today(self):
        good_weather = {
            "current_temperature": 20.0, "is_currently_raining": False,
            "hourly_precipitation_probability": [10.0, 10.0], "error": None
        }
    ...
    def test_get_next_mowing_time_bad_weather_today_good_later(self):
        ...
        raining_weather = {
            "current_temperature": 15.0, "is_currently_raining": True,
            "hourly_precipitation_probability": [100.0, 100.0], "error": None
        }
        good_weather = {
            "current_temperature": 20.0, "is_currently_raining": False,
            "hourly_precipitation_probability": [10.0, 10.0], "error": None
