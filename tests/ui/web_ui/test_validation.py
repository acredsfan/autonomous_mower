...
class TestValidateAddress(unittest.TestCase):
    ...
    def _mock_urlopen_response(self, status_code=200, response_dict=None, read_raises_error=None, is_http_error=False, http_error_code=None, http_error_reason=None):
    ...
    def test_http_error_from_api(self, mock_logger_error, mock_urlopen):
        ...
        mock_urlopen.side_effect = self._mock_urlopen_response(is_http_error=True, http_error_code=403, http_error_reason="Forbidden")
    ...
    def test_url_error_network(self, mock_logger_error, mock_urlopen):
        ...
        mock_logger_error.assert_called_with("Network error during Address Validation API call: Simulated network problem")
    ...
    def test_unexpected_error_during_api_call(self, mock_logger_error, mock_urlopen):
        ...
        mock_logger_error.assert_called_with("Unexpected error during Address Validation API call: Highly unexpected error")
